        ...
        <script language="javascript" type="text/javascript">
            ...
            $(function(){
            	$("#savebtn").click(function(){
            		$.post({
            			url:"${pageContext.request.contextPath }/admin/AddAdminAction.do",
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form id="myform" class="main_form">
                    ...
                    <div class="input_info">
                        <input type="text" name="adminPhone" class="width200"/>
                        <span class="required">*</span>
                        <div class="validate_msg_medium error_msg">正确的电话号码格式：手机或固话</div>
                    </div>
                    <div class="text_info clearfix"><span>Email：</span></div>
                    <div class="input_info">
                        <input type="text" name="adminEmail" class="width200"/>
                        <span class="required">*</span>
                    ...
                    <div class="input_info_high">
                        <div class="input_info_scroll">
                            <ul>
                           		<c:forEach items="${sessionScope.allRole }" var="role">
                           			<li><input type="checkbox" name="role" value="${role.roleID}" />${role.roleName }</li>
                           		</c:forEach>
                            </ul>
                        </div>
                        <span class="required">*</span>
